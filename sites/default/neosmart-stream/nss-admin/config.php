	...
	<form class="nss-admin-form" method="post">
		...
		<div class='row'>
			...
			<div class="field-area">
				...
				<div class="field-info">Hide posts which contains a word of this blacklist (comma separated). You can use this option to prevent Facebook from showing status updates.
					<br /><b>Default: 'on their own, likes their own photo'</b></div>
			</div>
		</div>
		<div class='row'>
