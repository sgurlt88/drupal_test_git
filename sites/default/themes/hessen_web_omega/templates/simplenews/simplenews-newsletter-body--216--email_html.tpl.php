...
<table width="738">
    <tr>
        ...
        <td style="vertical-align: top; width: 600px; height:70px;"><img src="http://<?php print $_SERVER['HTTP_HOST']; ?>/sites/default/themes/hessen_web_omega/css/images/NL/NL_Logo_hmdj.gif"></td>
    ...
    <tr>
		 <td>
			<div class="headline">Der Integrationsbrief</div><br>
			...
			<div style="font-size:9.5pt;"><?php print render($build['body']) ?><?php print render($build['field_inhalt']) ?></div><br>
						...
						<?php if($build['field_newsletter_anhang']): ?><div style=""><p style="font-size:9.5pt;font-weight:bold;">Den aktuellen Integrationsbrief finden Sie in der angef&uuml;gten PDF-Datei:
