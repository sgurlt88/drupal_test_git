<html>
<head>
<meta http-equiv=Content-Type content="text/html; charset=utf-8 Content-Transfer-Encoding: Der Intregrationsbrief8bit">
<style>
...
<table width="738">
    <tr>
        ...
        <td style="vertical-align: top; width: 600px; height:70px;"><img src="http://<?php print $_SERVER['HTTP_HOST']; ?>/sites/default/themes/hessen_web_omega/css/images/NL/NL_Logo_hessen.png"></td>
    ...
    <tr>
		 <td>
			<div class="headline">Newsletter</div><br>
			<?php print render($build['field_newsletter_datum']) ?>
			<?php print render($build['field_datum_default']) ?>
			<?php if($build['field_newsletter_anhang']): ?><div style=""><p style="font-size:9.5pt;font-weight:bold;">Einzelheiten zu den Themen der Woche finden Sie in der PDF-Datei, die Sie &uuml;ber den folgenden Link aufrufen k&ouml;nnen:
