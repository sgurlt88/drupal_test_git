...
<table width="738">
    <tr>
        ...
        <td style="vertical-align: top; width: 600px; height:70px;"><img src="http://<?php print $_SERVER['HTTP_HOST']; ?>/sites/default/themes/hessen_web_omega/css/images/NL/NL_Logo_hmdi.gif"></td>
	...
	<tr>
		<td  style="color:blue; font-size: 7.5pt" ><div style="float:left;">Adresse:&nbsp;</div><div style="float:left;margin-left:60px;"><?php print render($build['field_nref_pressestelle'][0]['field_adresse']); ?></div></td><td></td>
	</tr>
	<tr>
