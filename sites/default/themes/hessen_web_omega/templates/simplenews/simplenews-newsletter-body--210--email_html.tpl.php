...
<table style="width: 600px">
    <tr>
        ...
        <td style="vertical-align: top; width: 350px; height:70px;"><img src="http://<?php print $_SERVER['HTTP_HOST']; ?>/sites/default/themes/hessen_web_omega/css/images/NL/NL_Logo_newsletter_digitalfunk.gif"></td>
    ...
    <td colspan="2">
		...
		<?php print render($build['field_newsletter_datum']) ?><?php print render($build['field_datum_default']) ?>
		<br>
		<h2><?php print $title; ?></h2>
		<?php print render($build['field_newsletter_bild']) ?><?php print render($build['field_hauptbild'][0]['file']); ?>
		<br>
	...
	<hr color="#086CA3">
    <tr>
        <td name="andi" style="color:#086CA3; font-size: 8.5pt"><?php 
	...
	<tr>
        <td style="color: #086CA3; font-size: 8.5pt" colspan="2">
		<br>
